...
construir_educacion <- function(datos){
...
determinar_edu_obj_ilo <- function(ciuo08){
...
## Objetivo -------------------------------------------------------------------
asignar_edu_mismatch_obj <- function(datos, ciuo08){
...
```{r}
ocupada_procesda <- construir_educacion(ocupada)
ocupada_procesada <- construir_variables(ocupada_procesda)
ocupada_procesada <- construir_educacion_cine11(ocupada_procesada)
# sinco19 <- determinar_edu_objetivo_ilo(ciuo08)
ocupada_procesada <- asignar_edu_mismatch_obj(ocupada_procesada, ciuo08)
incidencia <- calcular_incidencia(ocupada_procesada)
```

En teoría se muestra incidencia
...
```{r}
jovenes <- seleccionar_jov(ocupada_procesada)
calcular_incidencia(jovenes)
```

Falta resto de variables, se hace en un archivo nuevo
