...
Con el propósito de propiciar la transparencia y la reproducibilidad de
los resultados presentados en esta investigación, se pone a disposición
el código fuente desarrollado en R, versión 4.5.1 (R Core Team, 2025).
Dicho proyecto permite reproducir en su totalidad el procesamiento de
los datos, las estimaciones econométricas, así como las figuras
empleadas a lo largo de este documento. En esta sección, se describen
los principales elementos necesarios para su utilización.

En primer lugar, la estructura general del proyecto es la siguiente:
    ...
    ├── README_v2-1.md
    ├── README_v2-1.qmd
    ├── README_v2-1.rmarkdown
    ├── renv
    ├── renv.lock
    ├── scripts
    └── tesis.Rproj

Para ejecutar el código por vez primera, se sugiere seguir los
siguientes pasos:
...
| `c4-3_resultados_estimacion.html` | HTML | Resultados de las estimaciones mostradas en la sección 4.3 |
...
`datos_procesados.xlsx`, que contiene los datos utilizados para
construir los cuadros y figuras presentados en esta investigación.
